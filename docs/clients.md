...
carry a live token. Every transcript line is rewritten on write: the userinfo of
a `scheme://` URL's authority becomes `***`, giving
...
>>>>>>> origin/build/build_1b80397a9ac24cceb144d736fb8b9a5b
